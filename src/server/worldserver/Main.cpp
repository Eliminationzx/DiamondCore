...
extern int main(int argc, char** argv)
{
	...
	sLog->outString("                       ░                                ░");
     ...
     sLog->outString("                     ░ ░        ▀ ░▀ ▀▀ ▀▀▀ ▀░ ▀        ░ ░");
     sLog->outString("                     ░ ░         ▀▓▓▓▓██████▓▓▀         ░ ░");
     sLog->outString("              ArathorCoreWotlk 2016(c) Privat-sourced Game Emulation ");
     sLog->outString("         <https://github.com/Eliminationzx/DiamondCore.git> ArathorCoreWotlk 3.3.5 ");
